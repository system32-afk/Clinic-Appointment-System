...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_DD_TRG_DB_COLLATION_MISSING = 10195; // [HY000] Util.Database collation is missing for trigger of table %s. Using Default character...
    ...
    public final static int ER_IB_MSG_726 = 12551; // [HY000] Util.Database was not shutdown normally!
    ...
    public final static int ER_IB_MSG_1104 = 12929; // [HY000] InnoDB Util.Database creation was aborted %swith error %s. You may need to delete the ibdata1 file ...
    ...
    public final static int ER_IB_MSG_1110 = 12935; // [HY000] Util.Database upgrade cannot be accomplished in read-only mode.
    public final static int ER_IB_MSG_1111 = 12936; // [HY000] Util.Database upgrade cannot be accomplished with innodb_force_recovery > 0
    ...
    public final static int ER_REDUCED_DBLWR_PAGE_FOUND = 14048; // [HY000] Util.Database page corruption of tablespace %s space_id: %u page_num: %u. Cannot recov...
    ...
    public final static int ER_DATABASE_NAME = 1631; // [HY000] Util.Database
    ...
    public final static int ER_NO_SUCH_DB = 3503; // [42Y07] Util.Database '%s' doesn't exist
    ...
    public final static int ER_CANNOT_SET_DATABASE_ENCRYPTION = 3827; // [HY000] Util.Database default encryption differ from 'default_table_encryption' setting, ...
